...
// ゲッター
func (ins *LoginUserPassword) Value() string {
	return ins.value
}

// コンストラクタ
func NewLoginUserPassword(value string) (*LoginUserPassword, *errs.DomainError) {
	...
	return &LoginUserPassword{value: value}, nil
}
