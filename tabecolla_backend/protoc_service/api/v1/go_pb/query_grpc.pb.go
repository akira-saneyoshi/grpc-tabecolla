...
func (c *storeCategoryQueryClient) List(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*StoreCategoriesResult, error) {
	...
	err := c.cc.Invoke(ctx, StoreCategoryQuery_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storeCategoryQueryClient) ById(ctx context.Context, in *StoreCategoryParam, opts ...grpc.CallOption) (*StoreCategoryResult, error) {
	...
	err := c.cc.Invoke(ctx, StoreCategoryQuery_ById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storeQueryClient) ListStream(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (StoreQuery_ListStreamClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StoreQuery_ServiceDesc.Streams[0], StoreQuery_ListStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &storeQueryListStreamClient{ClientStream: stream}
...
func (c *storeQueryClient) List(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*StoresResult, error) {
	...
	err := c.cc.Invoke(ctx, StoreQuery_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storeQueryClient) ById(ctx context.Context, in *StoreParam, opts ...grpc.CallOption) (*StoreResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StoreResult)
	err := c.cc.Invoke(ctx, StoreQuery_ById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storeQueryClient) ByKeyword(ctx context.Context, in *StoreParam, opts ...grpc.CallOption) (*StoresResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StoresResult)
	err := c.cc.Invoke(ctx, StoreQuery_ByKeyword_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _StoreQuery_ListStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StoreQueryServer).ListStream(m, &storeQueryListStreamServer{ServerStream: stream})
}
